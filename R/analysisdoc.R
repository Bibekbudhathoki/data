...
#'
#' @param filename Type as 'filename.doc' or 'filename.txt' if you want output as text file
...
#' @param factA Treatment name incase of LSD , RCBD and CRD
...
analysisdoc <- function(filename,design,model,data,rep, factA,factB,factC){
